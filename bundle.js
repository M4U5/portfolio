...
/*-----------------------------------------------------------------------------
  LOADING DATA
-----------------------------------------------------------------------------*/
minixhr('https://api.github.com/users/M4U5', responseHandler1)
...
function portfolioComponent ({ data = {}, theme = {} } = {}) {
        ...
        <div class="${css.portfolio}">
          <div class="${css.portfolioItem_isHover}">
            ...
            <div class="${css.portfolioBody_isHover}">
              My first quiz to ask few things about programming :)
             </div>
          </div>
        </div>
      </div>
  ...
  function openNewTab() {
    var url = "https://m4u5.github.io/quiz/"
